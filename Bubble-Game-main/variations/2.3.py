# 2.3 In this Code Snippet, We will generate continous obstacles that fall from the top of the screen.
# We will use a list to store the obstacles data and using loop we will draw and move the obstacles down the screen.
...
# Note: In this code, We have 2 issues:
# 1. The obstacles are created continuously without any limit.
# 2. We want if the obstacle goes out of the screen, it should be removed from the list because it is no longer visible.